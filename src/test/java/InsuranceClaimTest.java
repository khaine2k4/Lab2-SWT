...
import khainguyen.example.InsuranceClaim;
...
class InsuranceClaimTest {
    ...
    void testProcessClaimWhenNotPending() {
        claim.processClaim("Approved");  // Cập nhật trạng thái trước
        boolean result = claim.processClaim("Rejected");  // Không còn là "Pending"
        assertFalse(result);
        assertEquals("Approved", claim.getClaimStatus());  // Trạng thái không thay đổi
    }
